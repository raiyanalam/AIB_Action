    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                var outStream = '';
                console.log("Attempting to check Az cli version");
                yield this.executeAzCliCommand("--version");
                console.log("Successfully checked Az cli version");
                ...
                if (this._taskParameters.resourceGroupName == null || this._taskParameters.resourceGroupName == undefined || this._taskParameters.resourceGroupName.length == 0) {
                    ...
                    outStream = yield this.executeAzCliCommand(`group create -n ${resourceGroupName} -l ${this._taskParameters.location}`);
                    console.log("outstream "+outStream);
                    console.log("resource group " + resourceGroupName + " got created");
                }
                //template json for role definition 
                console.log("create role definition");
                ...
                console.log("template json for ole defn "+JSON.stringify(templateJsonRoleDefinition));
                //create image role defintion 
                output = yield this.executeAzCliCommand(`role definition create --role-definition ./src/template.json`);
                console.log("output from role defn "+output);
    ...
    executeAzCliCommand(command, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log("executeAzCliCommand "+outStream);
                return outStream;
            }
            catch (error) {
                console.log("command "+command + " and error is "+JSON.stringify(error));
                throw error;
            }
        });
    }
